...
<html>
    ...
    <body>
        <?php
             ...
             if($res_1 && mysqli_num_rows($res_1) > 0){
                 $image_1 = mysqli_fetch_assoc($res_1);
             }
     
             if($res_2 && mysqli_num_rows($res_2) > 0){
            ...
            <div class="match-header">
                ...
                <div class="match-tournament">
                    <?php if(isset($image_league)) { ?>
                        <img src="../HOST/images/<?= $image_league['league_img'] ?>" alt="Image Not Found" class="league-image">
                    <?php } ?>&nbsp;
    ...
    <div class="match-output">
        <table>
            ...
            <tr>
                <?php 
                    $attacks1_format = number_format($attacks1, 2);
                    $attacks2_format = number_format($attacks2, 2);
                ?>
                <td><?php echo $attacks1_format; ?></td>
                <td>Attack %</td>
                <td><?php echo $attacks2_format; ?></td>
            </tr>
            <tr>
                <?php 
            ...
            <tr>
                <td><?php echo $penalties1; ?></td>
                <td>Penalties Saved</td>
                <td><?php echo $penalties2; ?></td>
            </tr>
        </table>
    </div>
